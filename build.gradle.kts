...
dependencies {
    ...
    intellijPlatform {
        ...
        // v0.1 scope is Java + Kotlin only (see README "Why built this
        // way" for the full reasoning): both bundled plugins are part
        // of every IntelliJ IDEA edition this catalog already targets,
        // same two dependencies regex-named-group-companion uses for
        // its own dual Java/Kotlin PSI walk. Python/TypeScript PSI
        // would need PythonCore/JavaScript bundled modules that are
        // NOT guaranteed present in IntelliJ IDEA Community (Python
        // needs the separate PyCharm/Python plugin; JavaScript/
        // TypeScript support is an Ultimate-only bundled plugin) --
        // deferred to a possible v0.2, not silently assumed here.
